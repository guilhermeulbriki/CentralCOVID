...
<head>
  ...
  <title>Login - Central Covid-19</title>
            ...
            <div class="col-lg-5">
              <div class="card shadow-lg border-0 rounded-lg mt-5">
                <div class="card-header">
                  <h3 class="text-center font-weight-light my-4"><img src="../assets/images/logos/logo_covid.png " height="70px"></h3>
                </div>
                <div class="card-body">
                  <?php
                  if ($_REQUEST) {
                  ...
                  <form method="POST" role="form">
                    <div class="form-group">
                      ...
                      <input class="form-control py-4" id="inputEmailAddress" name="user" type="text" placeholder="Informe seu usuário" />
                    </div>
                    <div class="form-group">
                      <label class="small mb-1" for="inputPassword">
                        Senha
                      </label>
                      <input class="form-control py-4" id="inputPassword" name="senha" type="password" placeholder="Insira sua senha" />
                    </div>
                    <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                      <a class="small" href="malito:suporte@solidarizafw.com">
                        Caso tenha esquecido o usuário entre em contato com o suporte@cooperanors.tk
                      </a>
                  ...
                  if (@$_POST) {
                    ...
                    while ($row = $resultado->fetch_assoc()) {
                      if ($usr == $row['user_login'] && md5($senha) == $row['user_senha'] && $row['atv'] == 1 &&  $row['senhaEsquecida'] == 0) {
                        ...
                        $_SESSION['idCidade'] = $row['idCidade'];
      ...
      <footer class="py-4 bg-footerSite  mt-auto">
        <div class="container-fluid">
          <div class="d-flex align-items-center justify-content-between small">
            <div class="text-footer">Copyright &copy; Sistemas de Informação - UFSM FW <?php echo date('Y'); ?></div>
            <!--<div>
