              ...
              <div class="col-lg-5">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                  <div class="card-header">
                    <h3 class="text-center font-weight-light my-4"><img src="./assets/images/logos/coopera.png " height="70px"></h3>
                  </div>
                  <div class="card-body">
                    <?php
                    if ($_REQUEST) {
                    ...
                    <form method="POST" role="form">
                      ...
                      <div class="form-group"><label class="small mb-1" for="inputPassword">Nova senha</label>
                    ...
                    if (@$_POST) {
                      ...
                      while ($row = $resultado->fetch_assoc()) {
                        if ($usr == $row['user_login'] && md5($senha) == $row['user_senha'] && $row['atv'] == 1) {
