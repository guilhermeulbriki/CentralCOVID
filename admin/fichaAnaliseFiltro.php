  ...
  <div id="layoutSidenav_content">
    <main>
      <div class="container-fluid">
        <h1 class="mt-4">Análise de pacientes com filtro</h1>
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table style="width:100%" class="table table-striped table-bordered dt-responsive nowrap" id="dataTable" width="100%" cellspacing="0">
                <thead>
                  <tr>
                    <th>Nome</th>
                    <th>Prioridade</th>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h4 class="modal-title text-center" id="myModalLabel">Identificação do paciente <?php if ($row['suspeitoPaciente'] === 'EMANALISE') {
                                                                                                                echo " - EM ANALISE";
                                                                                                              } ?></h4>
                            ...
                            <div class="modal-body">
                              <div>
                                ...
                                <?php } else { ?>
                                <?php echo 'Não apresentadas comorbidades!';
                                } ?>
                                <br>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <?php } else { ?>
                              <?php echo "Paciente sem WhatsApp!";
                              } ?>
                            </div>
                          </div>
                        </div>
