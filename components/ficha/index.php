...
<head>
  ...
  <title>Ficha de pré-atendimento - Central Covid-19</title>
      ...
      <div class="col-sm">
        ...
        ?>
          <div class="card-header">
            Formulário para avaliação<button class="btn btn-danger btn-sm ml-2" data-toggle="modal"
              data-target="#help-modal"><i class="far fa-question-circle"></i> Leia antes de responder</button>
          </div>
          <div class="card-body">
            ...
            <form method="POST" action="../../services/fichaModel.php" enctype="multipart/form-data">
              <div class="form-row">
                <div class="form-group col-md-4">
                  ...
                  <input type="text" required class="form-control" name="nomeCompleto" id="nomecompleto"
                ...
                <div class="form-group col-md-2">
                  ...
                  <input type="text" required class="form-control" name="dataNascimento" id="dataNascimento"
              ...
              <div class="form-row">
                <div class="form-group col-md-2">
                  ...
                  <input type="text" required class="form-control" name="temperaturaAferidaPaciente"
                    placeholder="Somente nº Ex: 39.5" id="temperaturaAferidaPaciente">
                </div>
                ...
                <div class="form-group col-md-12">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="congestaoNasal" name="congestaoNasal"
                      value="SIM">
                ...
                <div class="form-group col-md-5">
                  ...
                  <input type="textarea" class="form-control" id="outrosSintomas" name="outrosSintomas"
              ...
              <div class="form-row">
                <div class="form-group col-md-12">
                  <label for="viajouPaciente"> <strong> Tem histórico de viagem para fora do Brasil até 14 dias antes do
                      início dos sintomas?
                    </strong></label>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="viajouPaciente" id="viajouPaciente1"
                      onclick="exibeOutros()" value="SIM" checked>
                    <label class="form-check-label" for="viajouPaciente1">
                      Sim
                      <input type="text" class="form-control" name="paisViajado" id="pais2"
                        placeholder="País para onde viajou?">
                    </label>
                  </div>
                  <div class="form-check col-md-3">
                    <input class="form-check-input" type="radio" name="viajouPaciente" id="viajouPaciente2"
                      onclick="exibeOutros2()" value="NÃO">
                ...
                <div class="form-group col-md-12">
                  <label for="contatosuspeitoPaciente"><strong>O paciente teve contato próximo com uma pessoa que seja
                      caso SUSPEITO de Novo Coronavírus (COVID-19)?
                    </strong>
                  </label>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="contatosuspeitoPaciente"
                      id="contatosuspeitoPaciente1" value="SIM" checked>
                  ...
                  <div class="form-check col-md-3">
                    <input class="form-check-input" type="radio" name="contatosuspeitoPaciente"
                      id="contatosuspeitoPaciente2" value="NÃO">
                ...
                <div class="form-group col-md-12">
                  <label for="contatoconfirmadoPaciente">
                    <strong>O paciente teve contato próximo com uma pessoa que seja caso CONFIRMADO de Novo Coronavírus
                      (COVID-19)?
                    </strong>
                  </label>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="contatoconfirmadoPaciente"
                      id="contatoconfirmadoPaciente1" value="SIM" checked>
                  ...
                  <div class="form-check col-md-3">
                    <input class="form-check-input" type="radio" name="contatoconfirmadoPaciente"
                      id="contatoconfirmadoPaciente2" value="NÃO">
                ...
                <div class="form-group col-md-12">
                  <label for="visitaUbsPaciente">
                    <strong>Esteve em alguma unidade de saúde e/ou hospital (UBS) nos 14 dias antes do início dos
                      sintomas?
                    </strong>
                  </label>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="visitaUbsPaciente" id="visitaUbsPaciente1"
                      value="SIM" onclick="unidadeVisitada()" checked>
                    <label class="form-check-label" for="visitaUbsPaciente1">
                      Sim
                      <input type="text" class="form-control" name="ubsVistada" id="unidade"
                        placeholder="UBS e/ou hosp. visitada?">

                    </label>
                  </div>
                  <div class="form-check col-md-3">
                    <input class="form-check-input" type="radio" name="visitaUbsPaciente" id="visitaUbsPaciente2"
                      value="NÃO" onclick="unidadeVisitada2()">
              ...
              <div class="form-group">
                <div class="form-check">
                  ...
                  <label class="form-check-label" for="gridCheck">
                    Declaro que todas as informações prestadas neste formulário são verdadeiras, pelas quais me
                    responsabilizo. Declaro estar ciente que é crime, previsto no Código Penal Brasileiro: "Omitir, em
                    ...
                    sobre o fato juridicamente relevante" (Art. 299).
                  </label>
                </div>
              </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Se você estiver suspeitando ter contraído Covid-19, leia atentamente cada pergunta do formulário abaixo e
            responda com sinceridade para que possamos ajudá-lo(a) da melhor forma possível.</p>

          <p>Primeiramente, insira seus dados pessoais com exatidão. Logo abaixo, informe-nos sua temperatura, a data em
            que passou a sentir os primeiros sintomas e selecione os sintomas apresentados. Em seguida, diga-nos com
            sinceridade se viajou para fora do país ou se teve contato com alguém que está com suspeita ou confirmação
            de ter contraído a doença. Informe-nos, ainda, se esteve em alguma unidade de saúde nos últimos 14 dias
            antes do início dos sintomas.</p>

          <p><strong>Atenção! Não omita nenhuma informação relevante e não minta no formulário. Para o seu próprio bem,
              você deve preencher todos os campos corretamente.</strong></p>
        </div>
